...
void updateItemArrayLength(char itemName[50], char scopeStack[50][50], int stackPointer, int newLen) {
	...
	// Else, return false
	fprintf(errorFile, "Semantic Error, line %d: Variable %s d1 does not exist.\n", lines, itemName);
	exit(1);
}
...
int getItemID(char itemName[50], char scopeStack[50][50], int stackPointer) {
	...
	// Else, return false
	fprintf(errorFile, "Semantic Error, line %d: Variable %s d2 does not exist.\n", lines, itemName);
	exit(1);
}
...
char* getItemKind(char itemName[50], char scopeStack[50][50], int stackPointer) {
	...
	// Else, return false
	fprintf(errorFile, "Semantic Error, line %d: Variable %s d3 does not exist.\n", lines, itemName);
	exit(1);
}
...
char* getItemType(char itemName[50], char scopeStack[50][50], int stackPointer) {
	...
	// Else, return false
	fprintf(errorFile, "Semantic Error, line %d: Variable %s d4 does not exist.\n", lines, itemName);
	exit(1);
}
...
int getArrayLength(char itemName[50], char scopeStack[50][50], int stackPointer) {
	...
	// Else, return false
	fprintf(errorFile, "Semantic Error, line %d: Variable %s d5 does not exist.\n", lines, itemName);
	exit(1);
}
