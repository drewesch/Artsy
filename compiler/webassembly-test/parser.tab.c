...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EQ = 7,                         /* EQ  */
  YYSYMBOL_LEFTBRACKET = 8,                /* LEFTBRACKET  */
  YYSYMBOL_RIGHTBRACKET = 9,               /* RIGHTBRACKET  */
...
{
       0,    51,    51,    62,    63,    65,    68,    72,    79,   105,
     106,   112,   113,   117,   122,   127,   128,   132,   147,   148,
     153,   157,   191
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "LEFTBRACKET", "RIGHTBRACKET", "NUMBER", "WRITE",
  "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "$accept", "Program", "DeclList",
  "Decl", "VarDecl", "StmtList", "Stmt", "Primary", "BinOp", "Block",
  "Expr", YY_NULLPTR
};
...
{
       0,    -2,     6,   -18,     0,   -18,    -3,     5,   -18,   -18,
       0,   -18,     8,   -18,   -18,     9,    18,    13,     8,   -18,
      19,   -18,   -18,   -18,   -18,   -18,    13,   -18,    15,    20,
     -18,    15,   -18
};
...
{
       3,     0,    16,    11,     3,    15,     0,     0,     2,     5,
       3,     7,     9,    20,    14,     0,     0,     0,    18,    16,
       0,     1,     4,    10,    12,    17,     0,     8,    21,     0,
      13,    22,    19
};
...
{
      28,    19,    16,     1,     2,    21,     3,     5,     4,    31,
       5,     6,     2,    17,     3,    24,     4,     2,     5,     6,
      18,    25,    23,     5,    27,    30,    22,    25,    29,    32,
      20
};

static const yytype_int8 yycheck[] =
{
      17,     4,     4,     3,     4,     0,     6,    10,     8,    26,
      10,    11,     4,     7,     6,     6,     8,     4,    10,    11,
       4,    12,    12,    10,     6,     6,    10,    12,    18,     9,
       6
};
...
{
       0,     3,     4,     6,     8,    10,    11,    17,    18,    19,
      20,    21,    22,    23,    25,    26,     4,     7,    18,     4,
      23,     0,    18,    21,     6,    12,    24,     6,    26,    21,
       6,    26,     9
};
...
#line 51 "parser.y"
	...
	(yyval.ast) = AST_SingleChildNode("program",(yyvsp[0].ast), (yyvsp[0].ast));
...
#line 1209 "parser.tab.c"
  ...
  case 13: /* Stmt: WRITE Primary SEMICOLON  */
#line 117 "parser.y"
...
#line 1251 "parser.tab.c"
  ...
  case 19: /* Block: LEFTBRACKET DeclList StmtList RIGHTBRACKET  */
#line 148 "parser.y"
